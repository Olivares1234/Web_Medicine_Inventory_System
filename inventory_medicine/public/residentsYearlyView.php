...
<body onload="print()">
	<div class="container" id="printThis">
		<center>
			<h3 style="margin-top: 30px"><span><i class="fas fa-file-medical-alt fa-lg" style="color:teal;"></i> </span>Total Vaccinated Yearly</h3>
			<hr>
		</center>
		...
		// no need if (isset) 
		$get_master_list = mysqli_query($conn,  "SELECT id,name,gender,age,address,civilstatus,citizenship,contact_no,vaccine,vaccinated,  YEAR(date) AS date FROM tbl_residents WHERE vaccinated='Yes' order by date");
