...
<head>
	...
	<title>HCBPCL - Total Vaccinated Monthly</title>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel"><span><i class="fas fa-hand-holding-medical fa-2x" style="color:teal;"></i> <i class="fas fa-notes-medical  fa-2x" style="color:teal;"></i></span> Total Vaccinated Monthly</h5>
						...
						<div class="content">
							<div class="container-fluid">
								<div class="page-title">
									<h3><span><i class="fas fa-syringe  fa-lg" style="color:teal;"></i> <i class="fas fa-notes-medical  fa-lg" style="color:teal;"></i></span> <b>Total Vaccinated Monthly</b>
								...
								<div class="box box-primary">
									<div class="box-body" >
										<table cellspacing="0" width="100%"  class="myTables table  table-hover table-bordered table-condensed  display nowrap">
												...
												<tbody>
													<?php 
								$getAll_query =  "SELECT id,name,gender,age,address,civilstatus,citizenship,contact_no,vaccine,vaccinated,  DATE_FORMAT(date,'%b%y') AS date FROM tbl_residents WHERE vaccinated='Yes' order by date ASC";
...
//			$row = mysql_fetch_array($result);
			...
			$total = $row[0];
			echo "<h5>Showing ".$total." of ".$total." Total Vaccinated Monthly</h5> ";
