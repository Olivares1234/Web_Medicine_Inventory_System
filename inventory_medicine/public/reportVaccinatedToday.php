...
<head>
	...
	<title>HCBPCL - Total Vaccinated Today</title>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel"><span><i class="fas fa-hand-holding-medical fa-2x" style="color:teal;"></i> <i class="fas fa-notes-medical  fa-2x" style="color:teal;"></i></span> Total Vaccinated Today</h5>
						...
						<div class="content">
							<div class="container-fluid">
								<div class="page-title">
									<h3><span><i class="fas fa-hand-holding-medical fa-lg" style="color:teal;"></i> <i class="fas fa-notes-medical  fa-lg" style="color:teal;"></i></span> <b>Total Vaccinated Today </b>
								...
								<div class="box box-primary">
									<div class="box-body" >
										<table cellspacing="0" width="100%"  class="myTables table  table-hover table-bordered table-condensed display nowrap">
												...
												<tbody>
													<?php 
								$getAll_query =  "SELECT * FROM tbl_residents WHERE vaccinated='Yes' AND DATE(`date`) = CURDATE()";
			...
			?>
						...
						<script type="text/javascript">
							...
							$(".detail").click(function() {
									...
									$.ajax({
										url: "reportViewVaccinatedToday.php",
										method: "post",
										data: {
