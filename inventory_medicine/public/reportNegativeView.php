...
<center>
	<h3 style="margin-top: 30px"><span><i class="fas fa-user-plus fa-lg" style="color:teal;"></i></span> Total Good Condition Reports</h3>
<hr>
</center>
<table id="ready" cellspacing="0" width="100%"  class="myTables table  table-hover table-bordered table-condensed display nowrap">
	<thead>
		<tr>
		    <th>ID</th>
			<th>Patient Name</th>
	...
	<tbody>
		...
		// no need if (isset) 
		$get_master_list = mysqli_query($conn, "SELECT * FROM tbl_checkups WHERE status='Good Condition'");
