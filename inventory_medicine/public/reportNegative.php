...
<head>
    ...
    <title>HCBPCL - Total Good Conditions</title>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><span><i class="fas fa-user-plus  fa-2x" style="color:teal;"></i> <i class="fas fa-notes-medical  fa-2x" style="color:teal;"></i></span> Total Good Conditions Report</h5>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="page-title">
                <h3><span><i class="fas fa-user-plus  fa-lg" style="color:teal;"></i> <i class="fas fa-notes-medical  fa-lg" style="color:teal;"></i></span> <b>Total Good Conditions </b>
                ...
                <div class="box-body">
                    <table cellspacing="0" width="100%" id="myTables" class=" table  table-hover table-bordered table-condensed display nowrap">
                        <center>
                            ...
                            <tbody>
                                <?php $getAll_query="SELECT * FROM tbl_checkups WHERE status='Good Condition'"; 
...
//			$row = mysql_fetch_array($result);
			...
			$total = $row[0];
			echo "<h5>Showing ".$total." of ".$total." Total Good Conditions</h5> ";
