...
<center>
<h3 style="margin-top: 30px"><span><i class="fas fa-user-injured fa-lg" style="color:teal;"></i></span> Total Bad Condition Reports</h3>
<hr>
</center>
<table id="ready" cellspacing="0" width="100%"  class="myTables table  table-hover table-bordered table-condensed display nowrap">
	...
	<tbody>
		...
		// no need if (isset) 
		$get_master_list = mysqli_query($conn, "SELECT * FROM tbl_checkups WHERE status='Bad Condition'");
