								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel"><span><i class="fas fa-user  fa-2x" style="color:teal;"></i> <i class="fas fa-clipboard-list fa-lg  fa-2x" style="color:teal;"></i></span> Total Checkups Daily Reports</h5>
							...
							<div class="content">
								<div class="container-fluid">
									<div class="page-title">
										<h3><span><i class="fas fa-user  fa-lg" style="color:teal;"></i> <i class="fas fa-file-medical  fa-lg" style="color:teal;"></i></span> <b> Total Checkups Daily Reports </b>
										...
										<div class="box-body">
											<table cellspacing="0" width="100%" id="myTables" class=" table  table-hover table-bordered table-condensed display nowrap">
												<center>
													...
													<tbody>
														<?php 
								$getAll_query =  "SELECT id,patient_name,age,status,comment, DATE_FORMAT(date,'%a - %M. %d. %y') as date FROM tbl_checkups order by date";
