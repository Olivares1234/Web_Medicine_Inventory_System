...
<body>
	...
	if(isset($_POST["btnSubmit"])){
		...
		$insert_query = mysqli_query($conn, "INSERT INTO tbl_medicines(name,image,stocks,supplier,date_added,date_expire) VALUES ('$vaccineName','$destinationfile','$stocks','$supplier','$dateAdded','$dateExpired')");
...
//				$dateExpired = mysqli_real_escape_string($conn, $_POST["dateExpired"]);
		...
		$edit_query1 = mysqli_query($conn, "UPDATE tbl_medicines SET image='$destinationfile1' WHERE id='$vaccineIDs'");
...
//						move_uploaded_file($filetmp,$destinationfile);
		...
		$edit_query = mysqli_query($conn, "UPDATE tbl_medicines SET  name='$name', stocks='$stocks', supplier='$supplier', date_added='$dateAdded', date_expire='$dateExpired' WHERE id='$vaccineID'");
...
//    }
	...
	if(isset($_POST["hids"])){
	$hid = $_POST(["hids"]);
	$query="SELECT * FROM tbl_medicines WHERE id='$hid'";
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"><span><i class="fas fa-pills  fa-2x" style="color:teal;"></i></span> Add New Record Medicines</h5>
                                                        <button  class="btn btn-danger" data-dismiss="modal">&times;</button>
                                                </div>
                                                <div class="modal-body text-left">
<!--                                                    <p>Add User</p>-->
                                                    <form method="POST" action="medicines.php" accept-charset="utf-8" enctype="multipart/form-data">
                                                        <div class="form-group">
                                                           <label for="supplier"><b>Required All Fields</b><span class="required">*</span></label>
                                                            <br>
                                                            <label for="vaccineName">Medicine Name:</label><span class="required">*</span>
                                                            <input type="text" spellcheck="false" name="name" placeholder="Enter Medicine Name..." class="form-control" required>
                                                        </div>
                                                          <div class="form-group">       
...
-->
                                     ...
                                     <div class="modal fade" id="vaccineModalUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"><span><i class="fas fa-pills  fa-2x" style="color:teal;"></i></span> Edit Record Medicine</h5>
                                                        <button  class="btn btn-danger" data-dismiss="modal">&times;</button>
                                                </div>
                                                <div class="modal-body text-left">
<!--                                                    <p>Add User</p>-->
                                                    <form method="POST" action="medicines.php" id="frmBox" accept-charset="utf-8" enctype="multipart/form-data">
                                                        <div class="form-group">
...
-->
                   ...
                   <div class="modal fade" id="detailInventory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"><span><i class="fas fa-pills  fa-2x" style="color:teal;"></i></span>   Detail Record Medicine</h5>
                                                        <button  class="btn btn-danger" data-dismiss="modal">&times;</button>
                                                </div>
                                                <div class="modal-body text-left" >
<!--                                                    <p>Add User</p>-->
                                                    <form method="POST" action="supplier.php" accept-charset="utf-8">
                                                        <div class="form-group" name="view" id="frmBox1">
                                                          <input type="hidden" name="hids" id="hids">
...
-->
                   ...
                   <div class="modal fade" id="changeImg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"><span><i class="fas fa-pills  fa-2x" style="color:teal;"></i></span>   Do you want to change Image?</h5>
                                                        <button  class="btn btn-danger" data-dismiss="modal">&times;</button>
                                                </div>
...
-->
                ...
                <div class="container-fluid">
                    <div class="page-title">
                        <h2><span><i class="fas fa-pills  fa-lg" style="color:teal;"></i></span> Medicines 
<!--                            <a href="roles.html" class="btn btn-sm btn-outline-primary float-right"><i class="fas fa-prescription-bottle-alt"></i> Add Vaccine</a>-->
                            <button type="button" class="btn btn-sm btn-outline-primary float-sm-right" data-toggle="modal" data-target="#vaccineModal"><i class="fas fa-pills"></i> Add Medicines</button>
                        </h2>
                    </div>
                    <div class="box box-primary">
                        <div class="box-body">
                            <table width="100%"  id="myTables"  class="table  table-hover table-bordered table-condensed display nowrap"  id="dataTables-example">
                                ...
                                <tbody>
                                    <?php 
								$getAll_query =  "SELECT * FROM tbl_medicines";
									$sql =  mysqli_query($conn, $getAll_query);
								while($medicines = mysqli_fetch_assoc($sql)){
									
								?>
                                    <tr>
                                    
                                    	<td class="id" ><?php echo $medicines["id"];?></td>
                                       	<td class="image"><img src="<?php echo $medicines["image"];?>" height="100px" width="100px" onclick="image(this)" class="rounded-circle" alt="No Images Found"></td>
                                        <td class="name"><?php echo $medicines["name"];?></td>
                                        <td style="display:none" class="stocks"><?php echo $medicines["stocks"];?></td>
                                        <td class=""><?php if ($medicines['stocks'] <= 0) { ?>
										<span class="label label-danger"><?php echo $medicines['stocks']; ?></span>
										<?php } elseif ($medicines['stocks'] <= 15) { ?>
										<span class="label label-warning"><?php echo $medicines['stocks']; ?></span>
										<?php } else { ?>
										<span class="label label-success"><?php echo $medicines['stocks']; ?></span>
										<?php } ?></td>
                                        <td class="supplier"><?php echo $medicines["supplier"];?></td>
                                        <td class="date_added"><?php echo $medicines["date_added"];?></td>
                                         <td class="date_expire"><?php echo $medicines["date_expire"];?></td>
           
                                        <td>
                                           <a href="medicines.php?detail=<?php echo $medicines["id"]?>" id="<?php echo $medicines["id"]?>"  class="detail btn btn-outline-primary btn-rounded" name="btnEditModal"  data-toggle="modal"><i class="fas fa-eye" data-toggle="tooltip" title="Detail"></i> Detail</a>
                                            <a href="medicines.php?edit=<?php echo $medicines["id"]?>"  class="edit btn btn-outline-info btn-rounded" name="btnEditModal"  data-toggle="modal"><i class="fas fa-pen" data-toggle="tooltip" title="Edit"></i> Edit</a>
                                             <a href="medicines.php?Img=<?php echo $medicines["id"]?>" id="<?php echo $medicines["id"]?>"  class=" img btn btn-outline-secondary btn-rounded" name="btnEditModal" data-toggle="modal"><i class="fas fa-image" data-toggle="tooltip" title="Edit"></i> change</a>
<!--                                            <a href="#?delete=<?php ?>"  class="delete btn btn-outline-danger btn-rounded deletebtn" name="btnDeleteModal"><i class="fas fa-trash"></i> Delete</a> -->
			...
			<?php 
//			count dataTable row
			$sql_count =  "SELECT COUNT(*) FROM tbl_medicines";
			$result =  mysqli_query($conn, $sql_count);
//			$row = mysql_fetch_array($result);
	        while($row = mysqli_fetch_array($result)){
			$total = $row[0];
			echo "<h5>Showing ".$total." of ".$total." Medicines</h5> ";
		 ...
		 // Functions button edit jquery
			 ...
			 // View Details Vacccine Inventory
			  ...
			  $(".detail").on('click', function(){
					 let checkID2 =  $(this).attr("id");
 
					 
					 $.ajax({
						 url:"medicinesView.php",
						 method:"post",
						 data:{checkID2:checkID2},
